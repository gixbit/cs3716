...
public class TournamentType extends JPanel {
	...
	/**
	 * Constructor for a TournamentType. Takes an ArrayList of Tournaments, also
	 * an integer that represents the index of the tournament
	 * 
	 * @param t
	...
	/**
	 * Constructor for a TournamentType. Takes an ArrayList of Tournaments and
	 * also takes the type as a string.
	 * 
	 * @param t
	 *            - Tournament
	 * @param type
	...
	/**
	 * Inner-Class that implements ActionListener When actionPerformed, sets the
	 * type of the tournament as well as listing them. Finally, Opens a
	 * ManageTournament frame.
	 *
	 */
	class choiceListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			if (bracketBox.getSelectedItem().equals("Single Elimination")) {
				numType = 1;
			} else if (bracketBox.getSelectedItem().equals("Double Elimination")) {
				numType = 2;
			} else {
				numType = 3;
			}
